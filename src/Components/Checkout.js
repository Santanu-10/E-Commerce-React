                    ...
                    <div className="bg-light p-30">
                        <div className="form-group">
                            <div className="custom-control custom-radio">
                                ...
                                <label className="custom-control-label" for="paypal">Card</label>
                            </div>
                        </div>
                        <div className="form-group">
                            <div className="custom-control custom-radio">
                        ...
                        <Link to = "/razorpaybutton"><button className="btn btn-block btn-primary font-weight-bold py-3" >Place Order</button></Link>
                    </div>
                </div>
            </div>
        </div>
